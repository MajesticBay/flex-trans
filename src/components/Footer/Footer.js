    ...
    return (
        <div className="footer">
            ...
            <div className="footer-info">
                ...
                <p>Terms & Conditions: All Pricing & Services are subject to change or update at any time by Flex-Trans with or without notice. We will honor all pricing & services in effect at the time of reservation. All payments are refundable upon cancellation at least one hour pick-up time.</p>
            </div>
        </div>
    );
}
