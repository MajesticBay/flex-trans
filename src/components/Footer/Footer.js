            ...
            <div className="footer__content">
                ...
                <div className="footer-info">
                    ...
                    <div className="footer-info__desktop">
                        <p>© 2020 Flex-trans Inc. All rights reserved. | Phone number: <a href="tel:(425) 260 2121">(425) 260 2121</a> | <a href="mailto:flex-trans@gmail.com" target="_blank" rel="noopener noreferrer">flex-trans@gmail.com</a></p>
                    </div>
